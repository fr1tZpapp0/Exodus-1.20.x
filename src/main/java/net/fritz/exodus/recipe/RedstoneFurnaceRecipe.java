...
public class RedstoneFurnaceRecipe extends AbstractCookingRecipe {
    public RedstoneFurnaceRecipe(ResourceLocation pId, String pGroup, CookingBookCategory pCategory,
    ...
    public ItemStack getToastSymbol() {
        return new ItemStack(ModBlocks.REDSTONE_FURNACE.get());
    }
    ...
    public static class Serializer implements RecipeSerializer<RedstoneFurnaceRecipe> {
        ...
        public static final RedstoneFurnaceRecipe.Serializer INSTANCE = new Serializer(50);

        public Serializer(int defaultCookingTime) {
            this.defaultCookingTime = defaultCookingTime;
        }

        public RedstoneFurnaceRecipe fromJson(ResourceLocation pRecipeId, JsonObject pJson) {
            ...
            return new RedstoneFurnaceRecipe(pRecipeId, s, cookingbookcategory, ingredient, itemstack, f, i);
        }

        public RedstoneFurnaceRecipe fromNetwork(ResourceLocation pRecipeId, FriendlyByteBuf pBuffer) {
        ...
        public void toNetwork(FriendlyByteBuf pBuffer, RedstoneFurnaceRecipe pRecipe) {
